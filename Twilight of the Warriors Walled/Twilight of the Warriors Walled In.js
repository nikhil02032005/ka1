...
function handleClick(page) {
    ...
    if (page === 'sakamoto1') {
        if (clickCounts.sakamoto1 === 1) {
            window.open("https://www.effectiveratecpm.com/wxmmscwyjt?key=3ad7df227f55ca82acc30e205189608b.com", "_blank");
        } else if (clickCounts.sakamoto1 === 2) {
            window.open('Twilight of the Warriors Walled In1.html', '_blank');
            clickCounts. sakamoto1 = 0;  // Reset click count for Movies
        }
    }
    if (page === 'sakamoto2') {
        if (clickCounts.sakamoto2 === 1) {
            window.open("https://www.effectiveratecpm.com/wxmmscwyjt?key=3ad7df227f55ca82acc30e205189608b.com", "_blank");
        } else if (clickCounts. sakamoto2 === 2) {
            window.open('Twilight of the Warriors Walled In2.html', '_blank');
            clickCounts. sakamoto2 = 0;  // Reset click count for Movies
        }
    }
    if (page === 'sakamoto3') {
        if (clickCounts.sakamoto3 === 1) {
            window.open("https://www.effectiveratecpm.com/wxmmscwyjt?key=3ad7df227f55ca82acc30e205189608b.com", "_blank");
        } else if (clickCounts. sakamoto3 === 2) {
            window.open('Twilight of the Warriors Walled In3.html', '_blank');
            clickCounts. sakamoto3 = 0;  // Reset click count for Movies
        }
    }
