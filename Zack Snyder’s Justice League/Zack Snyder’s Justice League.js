...
function handleClick(page) {
    ...
    if (page === 'sonic1') {
        if (clickCounts.sonic1 === 1) {
            ...
            window.open('Zack Snyder’s Justice League1.html', '_blank');
    ...
    if (page === 'sonic2') {
        if (clickCounts.sonic2 === 1) {
            ...
            window.open('Zack Snyder’s Justice League2.html', '_blank');
    ...
    if (page === 'sonic3') {
        if (clickCounts.sonic3 === 1) {
            ...
            window.open('Zack Snyder’s Justice League3.html', '_blank');
