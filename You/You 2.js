...
function handleClick(page) {
    ...
    if (page === 'sonic1') {
        if (clickCounts.sonic1 === 1) {
            ...
            window.open('You 21.html', '_blank');
    ...
    if (page === 'sonic2') {
        if (clickCounts.sonic2 === 1) {
            ...
            window.open('You 22.html', '_blank');
    ...
    if (page === 'sonic3') {
        if (clickCounts.sonic3 === 1) {
            ...
            window.open('You 23.html', '_blank');
    ...
    if (page === 'sonic4') {
        if (clickCounts.sonic4 === 1) {
            ...
            window.open('You 24.html', '_blank');
    ...
    if (page === 'sonic5') {
        if (clickCounts.sonic5 === 1) {
            ...
            window.open('You 25.html', '_blank');
    ...
    if (page === 'sonic6') {
        if (clickCounts.sonic6 === 1) {
            ...
            window.open('You 26.html', '_blank');
    ...
    if (page === 'sonic7') {
        if (clickCounts.sonic7 === 1) {
            ...
            window.open('You 27.html', '_blank');
    ...
    if (page === 'sonic8') {
        if (clickCounts.sonic8 === 1) {
            ...
            window.open('You 28.html', '_blank');
    ...
    if (page === 'sonic9') {
        if (clickCounts.sonic9 === 1) {
            ...
            window.open('You 29.html', '_blank');
    ...
    if (page === 'sonic10') {
        if (clickCounts.sonic10 === 1) {
            ...
            window.open('You 210.html', '_blank');
