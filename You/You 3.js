...
function handleClick(page) {
    ...
    if (page === 'sonic1') {
        if (clickCounts.sonic1 === 1) {
            ...
            window.open('You 31.html', '_blank');
    ...
    if (page === 'sonic2') {
        if (clickCounts.sonic2 === 1) {
            ...
            window.open('You 32.html', '_blank');
    ...
    if (page === 'sonic3') {
        if (clickCounts.sonic3 === 1) {
            ...
            window.open('You 33.html', '_blank');
    ...
    if (page === 'sonic4') {
        if (clickCounts.sonic4 === 1) {
            ...
            window.open('You 34.html', '_blank');
    ...
    if (page === 'sonic5') {
        if (clickCounts.sonic5 === 1) {
            ...
            window.open('You 35.html', '_blank');
    ...
    if (page === 'sonic6') {
        if (clickCounts.sonic6 === 1) {
            ...
            window.open('You 36.html', '_blank');
    ...
    if (page === 'sonic7') {
        if (clickCounts.sonic7 === 1) {
            ...
            window.open('You 37.html', '_blank');
    ...
    if (page === 'sonic8') {
        if (clickCounts.sonic8 === 1) {
            ...
            window.open('You 38.html', '_blank');
    ...
    if (page === 'sonic9') {
        if (clickCounts.sonic9 === 1) {
            ...
            window.open('You 39.html', '_blank');
    ...
    if (page === 'sonic10') {
        if (clickCounts.sonic10 === 1) {
            ...
            window.open('You 310.html', '_blank');
